            ...
            $("#button-akl").click(function(){
              console.log("auckland button working")
                $.get("/gym-akl", function(data, status){
                  $("#info-akl").append(JSON.stringify(data.Gyms.Auckland))
